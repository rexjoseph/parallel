...
const PromptForm: FC<PromptProps> = ({ apiKey, currentUser }) => {
  ...
  const handlePromptSubmit: (e: FormEvent<HTMLFormElement>) => void = async (
    ...
    while (!done) {
      ...
      setChatLog((prev) => [
        ...prev.slice(0, -1),
        { ...prev.slice(-1)[0], content: prev.slice(-1)[0].content + chunkValue }
      ]);
    }
              ...
              <main className="relative h-full w-full transition-width flex flex-col items-stretch flex-1">
                <div className="flex-1">
                  <div className="dark:bg-gray-800">
                    <div className="">
                      <div
                        className="container text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl p-4 md:py-6 flex lg:px-0"
                        onClick={switchPhone}
                      >
                        ...
                        {phoneLog.map((message, index) => (
                          ...
                          >
                            <div className="text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl p-4 md:py-6 flex lg:px-0 m-auto">
                              <div className="w-[30px] flex flex-col relative items-center">
                                {message.user === "me" && (
                    ...
                    <div className="relative flex h-full flex-1 md:flex-col">
                      ...
                      <div className="flex flex-col w-full flex-grow relative bg-white dark:text-white dark:bg-gray-700 shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
                        <textarea
                          ...
                          placeholder="Provide a number...+1234567890"
                          className="text-sm outline-0 m-0 md:pl-4 w-full resize-none border-0 bg-transparent py-2 pr-7 focus:ring-0 focus-visible:ring-0 dark:bg-transparent pl-2"
                        ></textarea>
                          ...
                          >
                            <div className="text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl p-4 md:py-6 flex lg:px-0 m-auto">
                              ...
                              <div className="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
                                <div className="flex flex-grow flex-col gap-3">
                                  <div className="min-h-[20px] flex flex-col items-start gap-4 whitespace-pre-wrap">
                                    <div className="text-xs markdown prose w-full break-words dark:prose-invert dark">
                                      {message.content}
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div className="relative flex h-full flex-1 md:flex-col">
                      ...
                      <div className="flex flex-col w-full flex-grow relative bg-white dark:text-white dark:bg-gray-700 shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
                        <textarea
                          ...
                          className="text-xs font-medium rounded-md outline-0 m-0 md:pl-4 w-full resize-none border-0 bg-transparent py-2 pr-7 focus:ring-0 focus-visible:ring-0 dark:bg-transparent pl-2"
                        ></textarea>
                        <button className="absolute p-1 rounded-md text-gray-500 bottom-1.5 md:bottom-2.5 hover:bg-gray-100 enabled:dark:hover:text-gray-400 dark:hover:bg-gray-900 disabled:hover:bg-transparent dark:disabled:hover:bg-transparent right-1 md:right-2 disabled:opacity-40">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div className="md:flex items-start text-center gap-3.5">
                            ...
                            <div className="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                              ...
                              <ul className="flex flex-col gap-3.5 w-full sm:max-w-md m-auto">
                                <button
                                  type="button"
                                  className="border border-white rounded-full px-4 py-1 text-xs font-semibold"
                                  onClick={switchPhone}
                                >
                                  Phone
                                </button>
