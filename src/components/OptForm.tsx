...
const OptForm: FC = () => {
  ...
  <div className="relative w-full max-w-md">
    <input value={email} onChange={(e) => setEmail(e.target.value)} className="w-full ring-transparent focus:outline-none focus:border-gray-400 py-3 px-8 md:pr-16 rounded-full bg-transparent border border-gray-700 transition hover:border-gray-400 hover:placeholder-white" placeholder="Enter Your Email" />
